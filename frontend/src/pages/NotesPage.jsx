    ...
    <ErrorBoundary>
      <DashboardLayout rightPanelContent={<NotesRightPanel createNote={saveNote} />}>
        <div className="w-full h-full flex flex-col gap-6 animate-in fade-in relative">
          ...
          {/* ========================================== */}
          {/* 🔥 TRUE GLASSMORPHISM & PERFECTLY CENTERED */}
          {/* ========================================== */}
          {isEditorOpen && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-md p-4 animate-in fade-in">
              {/* Changed h-[95vh] to h-[85vh] for centering, replaced bg-[#0a0a0a]/60 with bg-white/10 for glass */}
              <div className="w-full max-w-6xl h-[85vh] bg-white/10 backdrop-blur-3xl border border-white/20 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden">
                ...
                <div className="flex-1 flex overflow-hidden">
                  ...
                  {/* RIGHT SIDEBAR: Lighter glass instead of solid dark */}
          ...
          {/* FOLDER MODAL */}
          {folderModal.isOpen && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/50 backdrop-blur-md animate-in fade-in">
