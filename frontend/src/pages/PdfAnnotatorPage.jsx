      ...
      <div className="flex-1 w-full flex overflow-hidden">
        {!pdfUrl ? (
          ...
          <div className="flex-1 flex w-full h-full">
            ...
            <div className="w-2/3 h-full border-r border-white/10 bg-white">
              <object data={`${pdfUrl}#toolbar=0`} type="application/pdf" className="w-full h-full">
                 <div className="flex flex-col items-center justify-center h-full text-black">
                    ...
                    <a href={pdfUrl} target="_blank" rel="noreferrer" className="px-4 py-2 bg-indigo-500 text-white rounded">Open PDF in New Tab</a>
                 </div>
              </object>
            </div>
